        ...
        result = AGTable(
            ...
            column_defs = AbstractColumnDef[
                AgStringColumnDef(
                    ...
                    header_name = "a",
                    filter = false,
                    initial_sort = AG_NULL_SORT,
                    width = nothing,
                    cell_background = "#fff",
                    rect_background = "#fff",
                    color = "#000",
                    text_align = AG_LEFT,
                    equals = Dict{String,String}(),
                    threshold = nothing,
                ),
                AgStringColumnDef(
                    field_name = "b",
    ...
    @testset "Case №2: Custom tables" begin
        table = ag_table(
            ...
            AgNumberColumnDef(
                ...
                color = "#333",
                text_align = AG_RIGHT,
                equals = Dict(1 => "blue", 2 => "blue", 3 => "blue"),
        ...
        table = ag_table(
            ...
            AgTimeColumnDef(
                ...
                color = "#333",
                text_align = AG_LEFT,
                equals = Dict(Date(2024) => "blue", Date(2025) => "blue"),
        ...
        table = ag_table(
            ...
            AgStringColumnDef(
                ...
                color = "#333",
                text_align = AG_LEFT,
                equals = Dict("text" => "blue", "txt" => "blue"),
